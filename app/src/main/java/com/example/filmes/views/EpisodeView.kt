...
class EpisodeView (viewGroup: ViewGroup, private var seriesId: String, private var fragmentManager: FragmentManager ) : BaseViewHolder<com.example.filmes.di.Episode>(
